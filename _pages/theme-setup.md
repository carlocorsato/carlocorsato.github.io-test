...
Simply Academia now requires [Jekyll](http://jekyllrb.com/) 3.0. Make sure to run `bundle update` if you aren't on the latest version to update all gem dependencies.

If you are creating a new Jekyll site using So Simple follow these steps:

1. Fork the [Simply Academia](http://github.com/mmistakes/so-simple-theme/fork).
